...
COPY /opt/apache-tomcat-9.0.52/conf/tomcat-users.xml /opt/tomcat/conf/
COPY /opt/apache-tomcat-9.0.52/webapps/manager/META-INF/context.xml /opt/tomcat/webapps/manager/META-INF/
